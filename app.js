...
function renderSplashPreview() {
  ...
  const saveAction = `<button class="preview-save-card" data-action="save-preview-image"><i class="preview-save-icon">↓</i><span><strong>保存开屏图片</strong><small>保存当前预览效果</small></span><em>${state.previewSaved ? '已保存' : '保存'}</em></button>`;
